/**
 * Editor Screen
 * Obsidian-like Markdown editor within the demo screenset
 * Orchestrates: EditorInner inside MilkdownProvider
 */
 ...
 * Wraps EditorInner in MilkdownProvider for context
 */
export const EditorScreen: React.FC = () => {
  useScreenTranslations(DEMO_SCREENSET_ID, EDITOR_SCREEN_ID, translations);

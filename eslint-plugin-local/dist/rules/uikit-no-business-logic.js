...
const rule = {
    meta: {
        ...
        messages: {
            noBusinessLogicImport: 'UIKit components cannot import from @hai3/react or @hai3/framework (except types). ' +
    ...
    create(context) {
        ...
        const isInScreensetsUikit = (filename.includes('/screensets/') || filename.includes('\\screensets\\')) &&
...
module.exports = rule;
//# sourceMappingURL=uikit-no-business-logic.js.map